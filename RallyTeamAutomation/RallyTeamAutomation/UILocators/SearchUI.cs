...
namespace RallyTeam.UILocators
{
    public static class SearchUI
    {
        ...
        public readonly static By searchPage = By.XPath("//h2[contains(text(), 'Search Page')]");
        ...
        public readonly static By search = By.Name("search");
        public readonly static By searchBtn = By.XPath("//button[contains(text(), 'Search')]");
        ...
        public readonly static By zeroSearch = By.XPath("//h2[contains(text(), '0 results found for: ')]");
